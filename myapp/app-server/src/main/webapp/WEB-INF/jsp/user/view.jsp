...
<c:if test="${not empty user}">
    ...
    <a href="https://kr.object.ncloudstorage.com/bitcamp-bucket075/user/${user.photo}">
    <img src="https://tg1r4kjz4936.edge.naverncp.com/94ppDaDRPr/user/${user.photo}?type=f&w=100&h=100"></a><br>
