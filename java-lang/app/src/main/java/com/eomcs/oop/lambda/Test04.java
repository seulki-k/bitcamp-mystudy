...
public class Test04 {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(c1.compute(1000_000));

    System.out.println(create2(0.035).compute(1000_000));
    System.out.println(create3(0.035).compute(1000_000));
    System.out.println(create4(0.035).compute(1000_000));
    System.out.println(create5(0.035).compute(1000_000));
    System.out.println(create6(0.035).compute(1000_000));
